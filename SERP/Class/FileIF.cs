...
namespace SERP
{
    public class FileIF
    {
        ...
        public static void Excel_Down(GridControlEx gridControl, string sFormNM)
        {
            try
            {
        ...
        private static void File_Open(string sFileNM)
        {
            ...
            fileOpen.FileName = sFileNM + "_" + DateTime.Now.ToString("yyyyMMdd");
