...
namespace SERP
{
    public partial class rptMatPoCustom : BaseReg
    {
        ReturnStruct ret = new ReturnStruct();
        DataSet ds = new DataSet();

        public rptMatPoCustom()
        {
            InitializeComponent();
        }

        private void rptMatPoCustom_Load(object sender, EventArgs e)
        {
            //버튼 클릭 이벤트 선언
        ...
        private void Grid_Set()
        {
            ...
            // Quot_M 그리드
            DbHelp.GridSet(gc_MatPoM, gv_MatPoM, "Short_Name", "거래처", "120", false, false, true);
            ...
            DbHelp.GridSet(gc_MatPoM, gv_MatPoM, "Total", "합계", "125", false, false, true);
        ...
        {
            FileIF.Excel_Down(gc_MatPoM, "발주현황 (거래처)");
        }
