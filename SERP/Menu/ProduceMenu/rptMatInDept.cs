...
namespace SERP
{
    public partial class rptMatInDept : BaseReg
    {
        ...
        private void rptMatInDept_Load(object sender, EventArgs e)
        {
            //버튼 클릭 이벤트 선언
        ...
        private void Grid_Set()
        {
            ...
            // Quot_M 그리드
            DbHelp.GridSet(gc_MatInM, gv_MatInM, "Dept_Name", "부서", "120", false, false, true);
        ...
        {
            FileIF.Excel_Down(gc_MatInM, "구매현황 (부서)");
        }
        ...
        private void Search_Data()
        {
            ...
            Set_Total();
            DbHelp.Group_Footer_Set(gv_MatInM, ForMat.SetDecimal("regMatIn", "Amt1").NullString());
        }
