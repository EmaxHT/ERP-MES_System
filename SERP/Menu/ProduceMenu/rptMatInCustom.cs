...
namespace SERP
{
    public partial class rptMatInCustom : BaseReg
    {
        ReturnStruct ret = new ReturnStruct();

        public rptMatInCustom()
        {
            InitializeComponent();
        }

        private void rptMatInCustom_Load(object sender, EventArgs e)
        {
            //버튼 클릭 이벤트 선언
        ...
        private void Grid_Set()
        {
            ...
            // Quot_M 그리드
            DbHelp.GridSet(gc_MatInM, gv_MatInM, "Short_Name", "거래처", "120", false, false, true);
            ...
            DbHelp.GridSet(gc_MatInM, gv_MatInM, "Total", "합계", "125", false, false, true);
        ...
        {
            FileIF.Excel_Down(gc_MatInM, "구매현황 (거래처)");
        }
