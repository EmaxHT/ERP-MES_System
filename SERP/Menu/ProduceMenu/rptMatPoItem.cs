...
namespace SERP
{
    public partial class rptMatPoItem : BaseReg
    {
        ...
        private void rptMatPoItem_Load(object sender, EventArgs e)
        {
            //버튼 클릭 이벤트 선언
        ...
        private void Grid_Set()
        {
            ...
            // Quot_M 그리드
            DbHelp.GridSet(gc_MatPoM, gv_MatPoM, "Item_Name", "품목명", "120", false, false, true);
        ...
        {
            FileIF.Excel_Down(gc_MatPoM, "발주현황 (품목)");
        }
