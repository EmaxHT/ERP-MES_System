...
namespace SERP
{
    public partial class rptMatStock : BaseReg
    {
        ...
        private void rptMatStock_Load(object sender, EventArgs e)
        {
            //버튼 클릭 이벤트 선언
        ...
        private void Grid_Set()
        {
            ...
            DbHelp.GridSet(gc_StockLeft, gv_StockLeft, "Qty", "재고수량", "", false, false, true);
        ...
        {
            FileIF.Excel_Down(gc_StockLeft, "현재고현황");
        }
        ...
        private void Search_Data(string side = "")
        {
            ...
            if (side == "L")
            {
                ...
                DbHelp.Footer_Set(gv_StockLeft, ForMat.SetDecimal(this.Name, "Qty1").NullString(), new string[] { "Qty" });
            }
            ...
            else if (side == "R")
            {
                ...
                DbHelp.Footer_Set(gv_StockRight, ForMat.SetDecimal(this.Name, "Amt1").NullString(), new string[] { "Amt" });
            }
        }
        ...
        private void gv_StockLeft_FocusedRowObjectChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowObjectChangedEventArgs e)
        {
