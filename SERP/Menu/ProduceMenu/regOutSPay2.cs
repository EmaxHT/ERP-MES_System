...
namespace SERP
{
    public partial class regOutSPay2 : BaseReg
    {
        public regOutSPay2()
        {
            InitializeComponent();
        ...
        private void regOutSPay2_Load(object sender, EventArgs e)
        {
            Grid_Set();
        ...
        private void Grid_Set()
        {
            ...
            DbHelp.GridSet(gc_OutPayM, gv_OutPayM, "Pay_Amt", "합계금액", "100", true, false, true);
        }
        ...
        {
            FileIF.Excel_Down(gc_OutPayM, "외주비등록");
        }
