...
namespace SERP
{
    public partial class Report_Quot : DevExpress.XtraReports.UI.XtraReport
    {
        public Report_Quot()
        {
            InitializeComponent();
        ...
        public Report_Quot(DataSet ds, string preview = "N") : this()
        {
            SetInit(ds, preview);
        }
        ...
        {     
            ...
            S_CPrice.Text = dt1.Rows[0]["S_CPrice"].ToString();
            //S_TotalCPrice.Text = dt1.Rows[0]["S_TotalCPrice"].ToString();
            S_SPrice.Text = dt1.Rows[0]["S_SPrice"].ToString();
            S_TotalSPrice.Text = dt1.Rows[0]["S_TotalSPrice"].ToString();

            //S_Qty.TextFormatString = "{0:n}";
            //S_CPrice.TextFormatString = "{0:n}";
            //S_TotalCPrice.TextFormatString = "{0:n}";
            //S_SPrice.TextFormatString = "{0:n}";
            //S_TotalSPrice.TextFormatString = "{0:n}";
            ...
            //S1_Item_Part.DataBindings.Add("Text", null, dt.Columns["S1_Item_Part"].ColumnName);
            //S1_Item_Name.DataBindings.Add("Text", null, dt.Columns["S1_Item_Name"].ColumnName);
            //S1_Qty.DataBindings.Add("Text", null, dt.Columns["S1_Qty"].ColumnName, "{0:#,#}");
